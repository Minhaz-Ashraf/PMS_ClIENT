...
const ManufacturerTab = ({ selectedManufacturer, handleTabClick }) => {
  return (
    <div className="flex flex-row md:justify-center sm:justify-center scrollbar-hide justify-between overflow-x-auto whitespace-nowrap md:gap-20 sm:gap-12 gap-6 pt-12 md:ml-28 sm:ml-[30%] ml-6 ">
      <span
