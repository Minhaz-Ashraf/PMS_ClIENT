    ...
    <>
      <div ref={pdfRef}>
        <div className=" text-black rounded  py-8 px-6">
          <h1 className="text-xl font-bold text-black-600 mb-4 text-center">
          ...
          <span className="text-[13px]">
            ...
            <p className="mb-4">
              ...
              Vehicle with the 360 Car Protect Extended Warranty.
            </p>
            <p className="mb-4">
              You can now enjoy the benefits of 360 Car Protect Extended
              Warranty, as per the terms &amp; conditions set out in Annexure A.
            </p>
            <p className="mb-4">
              ...
              the time of availing the 360 Car Protect Extended Warranty.
            </p>
            <p className="mb-4">Wish you happy &amp; safe driving.</p>
            <div className="mb-4 text-end pt-6">
              <p>_________________________</p>
              <p>(Stamp &amp; Signature)</p>
              <p>For 360 Car Protect India LLP</p>
              <p>Name of Signatory: [__]</p>
              <p>Location: [__]</p>
              <p>Date: [__]</p>
            </div>
            ...
            <p className="font-normal pt-6">
              ...
              360 Car Protect India LLP is offering the 360 Car Protect Extended
              Warranty. 360 Car Protect India LLP has engaged the services of
              Raam Autobahn India Private Limited for the limited purpose of
              marketing and selling the 360 Car Protect Extended Warranty to the
              customers
            </p>
            ...
            <div className="mt-[88%]">
              ...
              <h3 className="text-xl font-bold text-black-600 underline mt-[30%] mb-2">
                Important Notes:
              </h3>
              ...
              <ul className="list-decimal list-outside items-start   mb-4">
                ...
                <li>
                  By choosing to protect the Vehicle through the 360 Car Protect
                  Extended Warranty, the Customer hereby confirms that they have
                  read and understood the terms and conditions governing the 360
                  Car Protect Extended Warranty set out in this Certificate and
                  in Annexure A and agrees and undertakes to abide by the same.
                </li>
                <li>
                  ...
                  Protect Extended Warranty as null and void and 360 Car Protect
                  India LLP shall not have any obligation or liability to the
                  Customer or any other person under the 360 Car Protect
                  Extended Warranty.
                </li>
                <li>
                  360 Car Protect Extended Warranty will be honored at all the
                  authorized service centers which are listed in Annexure B. The
                  said list may be updated from time to time by 360 Car Protect
                  India LLP on its website
                </li>
                <li>
                  360 Car Protect Extended Warranty is exclusively offered by
                  360 Car Protect India LLP and the Vehicle Manufacturer and/or
                  Raam Autobahn India Private Limited, their personnel,
                  shareholders and directors shall not be liable for any loss or
                  damage that may be suffered by the Customer on account of any
                  acts or omissions of 360 Car Protect India LLP. The Customer
                  shall not make any claims related to the 360 Car Protect
                  Extended Warranty against the Vehicle Manufacturer and/or Raam
                  Autobahn India Private Limited, their personnel, shareholders
                  and directors under any circumstances.
                </li>
                <li>
                  ...
                  part is covered under the said policy before making any claim
                  under the 360 Car Protect Extended Warranty.
                </li>

                <li>
                  If the Customer is desirous of seeking cancellation of the 360
                  Car Protect Extended Warranty, the same can only be done
                  within 15 days from the date of issuance of the Certificate.
                  The Customer shall be refunded the entire amount paid by the
                  Customer (less the GST amount and less 10% of the total amount
                  paid by the Customer for obtaining the 360 Car Protect
                  Extended Warranty.
                </li>
                <li>
                  Any claim under the 360 Car Protect Extended Warranty can only
                  be made after the Cooling Off Period mentioned in the
                  Certificate.
                </li>
              </ul>
              <div className="border border-black pt-1 px-6 pb-14 w-full">
                ...
                <p className="pt-2 text-start pe-20">Customer Signature: </p>
                <p className="pt-5 text-start pe-20">Date: </p>
              </div>
            </div>
            <div className="text-center border border-black font-bold text-xl mt-[62%] py-6">
            ...
            <ul className=" list-decimal list-outside mt-6">
              <li>
                Call the any Silver Star Dealership and provide the details of
                your 360 Car Protect Extended Warranty and the defective part of
                the Vehicle which is to be repaired/replaced.
              </li>
              <li>
                {" "}
            ...
            <p className="mt-6">
              Any servicing or repair undertaken or replacement of any Vehicle
              ...
              LLP) shall render the 360 Car Protect Extended Warranty as null
              and void. As regards the Vehicle part sought to be repaired or
              replaced under this 360 Car Protect Extended Warranty, if any
              unauthorized service or repair or replacement of the Vehicle part
              deals, or affects (directly or indirectly) the Vehicle part sought
              to be repaired or replaced under the 360 Car Protect Extended
              Warranty.
            </p>
            <p className="mt-6">
            ...
            <div>
              <table className="min-w-full border-collapse border border-black mt-[200px]">
                <thead>
                  <tr>
                    <th
                      colSpan="2"
              ...
              <p className="mt-[124%] underline  font-bold text-center text-xl ">
                {" "}
                Schedue A
              </p>
              <p className="underline  font-bold text-xl text-center">
                {" "}
                What is Covered under the 360 Car Protect Extended Warranty)
              </p>
            ...
            <div className="mt-6 border-2 border-black pb-14 pl-6 pt-3">
              <p className="font-bold underline ">Customer Declaration:</p>
              <p>
                I / we hereby accept, that I / we have read and understood the
                terms and conditions of 360 Car Protect Extended Warranty.
              </p>
              <p className="pt-6">Customer Signature:</p>
              <p>Date:</p>
              <p></p>
            </div>
            <p className="font-bold underline mt-16 text-xl text-center ">
              ANNEXURE B
            </p>
            ...
            <p className="mt-7">
              {" "}
              <span className="font-bold">Note:</span>: 360 Car Protect Extended
              Warranty will be honored at all authorized service centers which
              are listed above.{" "}
            </p>
            <div className="mt-6 border border-black pb-14 pl-6 pt-3">
              <p className="font-bold underline ">Customer Declaration:</p>
              <p>
                I / we hereby accept, that I / we have read and understood the
                terms and conditions of 360 Car Protect Extended Warranty.
